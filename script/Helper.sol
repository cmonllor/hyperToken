...
contract Helper {
    ...
    function getCCTAddressesByNetwork( SupportedNetworks network)
        external
        pure
        returns (
            address RMN,
            address tokenAdminRegistry,
            address registerAdminModuleCustom
        )
    {
        if(network == SupportedNetworks.ETHEREUM_SEPOLIA) {
            return (0xba3f6251de62dED61Ff98590cB2fDf6871FbB991, 0x95F29FEE11c5C55d26cCcf1DB6772DE953B37B82, 0x62e731218d0D47305aba2BE3751E7EE9E5520790);
        } else if(network == SupportedNetworks.ARBITRUM_SEPOLIA) {
            return (0x9527E2d01A3064ef6b50c1Da1C0cC523803BCFF2, 0x8126bE56454B628a88C17849B9ED99dd5a11Bd2f, 0xE625f0b8b0Ac86946035a7729Aba124c8A64cf69);
        } else if(network == SupportedNetworks.AVALANCHE_FUJI) {
            return (0xAc8CFc3762a979628334a0E4C1026244498E821b, 0xA92053a4a3922084d992fD2835bdBa4caC6877e6, 0x97300785aF1edE1343DB6d90706A35CF14aA3d81);
        } else if(network == SupportedNetworks.OPTIMISM_SEPOLIA) {
            return (0xb40A3109075965cc09E93719e33E748abf680dAe, 0x1d702b1FA12F347f0921C722f9D9166F00DEB67A, 0x49c4ba01dc6F5090f9df43Ab8F79449Db91A0CBB);
        }
    }
}
